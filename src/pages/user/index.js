        ...
        return (
            <div>
                ...
                <Card style={{marginTop:10}}>
                    <Button style={{marginRight:10}} type="primary" icon="plus" onClick={()=>this.handleOperator('create')}>创建员工</Button>
                    <Button style={{marginRight:10}} icon="edit" onClick={()=>this.handleOperator('edit')}>编辑员工</Button>
                    <Button style={{marginRight:10}} onClick={()=>this.handleOperator('detail')}>员工详情</Button>
